# Generated by Django 2.1.7 on 2019-07-10 02:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_list', models.ManyToManyField(blank=True, related_name='students', to='Crm.ClassList', verbose_name='已报班级')),
                ('customer', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Crm.Customer', verbose_name='客户信息')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classstudyrecord', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Crm.ClassStudyRecord', verbose_name='第几天课程')),
