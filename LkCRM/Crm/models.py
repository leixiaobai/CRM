...
class UserInfo(AbstractUser):
    """员工表"""
    telphone = models.CharField(max_length=32, null=True, blank=True)
    depart=models.ForeignKey("Department",null=True, blank=True, on_delete=models.CASCADE,default=1)
...
class Customer(models.Model):
    ...
    qq_name = models.CharField('QQ昵称', max_length=64, blank=True, null=True, default='')
    ...
    def get_status_color_show(self):
        ...
        return mark_safe('<span style="background-color:#E5E5E5;color:%s">%s</sapn>'%(status_color[self.status], self.get_status_display()))
...
class ConsultRecord(models.Model):
    ...
    # def __str__(self):
        # return "{}{}".format(self.customer, self.consultant)
